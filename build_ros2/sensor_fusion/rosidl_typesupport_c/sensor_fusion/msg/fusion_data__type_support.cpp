...
static const _FusionData_type_support_symbol_names_t _FusionData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sensor_fusion, msg, FusionData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_fusion, msg, FusionData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sensor_fusion, msg, FusionData)() {
  return &::sensor_fusion::msg::rosidl_typesupport_c::FusionData_message_type_support_handle;
}
