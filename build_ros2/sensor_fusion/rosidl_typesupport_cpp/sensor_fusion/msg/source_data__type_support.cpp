...
static const _SourceData_type_support_symbol_names_t _SourceData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_fusion, msg, SourceData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_fusion, msg, SourceData)),
  }
};
...
{
  return &::sensor_fusion::msg::rosidl_typesupport_cpp::SourceData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_fusion, msg, SourceData)() {
  return get_message_type_support_handle<sensor_fusion::msg::SourceData>();
}
