...
static const _LidarMsg_type_support_symbol_names_t _LidarMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_plc, msg, LidarMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_plc, msg, LidarMsg)),
  }
};
...
{
  return &::ros_plc::msg::rosidl_typesupport_cpp::LidarMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_plc, msg, LidarMsg)() {
  return get_message_type_support_handle<ros_plc::msg::LidarMsg>();
}
