...
{ 
    KWindowRows = node->declare_parameter("KWindowRows", 3);
    KWindowCols = node->declare_parameter("KWindowCols", 3);
    grid_width_ = node->declare_parameter("grid_width", 0.1);
    grid_length_ = node->declare_parameter("grid_length", 0.2);
    max_ground_height_threshold_ = node->declare_parameter("max_ground_height_threshold", 1.0);
    covariance_threshold_ = node->declare_parameter("covariance_threshold_", 0.05);
    height_of_hole_ = node->declare_parameter("height_of_hole", -0.1);
    min_dis_neighbour_points_threshold_ =
      node->declare_parameter("min_dis_neighbour_points_threshold_", 0.5);
    min_num_neighbour_points_threshold_ =
      node->declare_parameter("min_num_neighbour_points_threshold_", 2);
}
/*
